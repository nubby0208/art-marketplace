...
export interface IAuction extends IAuctionDocument {
  addBid(userId: Types.ObjectId, bidAmount: number): Promise<IAuction>
...
schema.method(
  'addBid',
  async function (userId: Types.ObjectId, bidAmount: number) {
    ...
    const bid: AuctionBid = { userId: userId as unknown as string, bidAmount }
